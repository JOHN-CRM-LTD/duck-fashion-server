...
echo "and this key as its api_token. The public proxy must forward /stock-api/glacier/* to this"
echo "service's /glacier/* (same prefix rewrite as the stock routes)."
